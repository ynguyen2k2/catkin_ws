...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CalibrateLinearConfig::AbstractParamDescriptionConstPtr(new CalibrateLinearConfig::ParamDescription<int>("direction", "int", 0, "A size parameter which is edited via an enum", "{'enum': [{'name': 'Y', 'type': 'int', 'value': 0, 'srcline': 9, 'srcfile': '/home/jetson/catkin_ws/src/yahboomcar_bringup/cfg/CalibrateLinear.cfg', 'description': 'first data', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'X', 'type': 'int', 'value': 1, 'srcline': 9, 'srcfile': '/home/jetson/catkin_ws/src/yahboomcar_bringup/cfg/CalibrateLinear.cfg', 'description': 'two data', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set size'}", &CalibrateLinearConfig::direction)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/jetson/catkin_ws/src/yahboomcar_bringup/cfg/CalibrateLinear.cfg"
